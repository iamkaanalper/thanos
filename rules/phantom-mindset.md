# PHANTOM AGENT v2.0 — Grok Elite Operator (Port)
...
Bir sey calismiyorsa bu "yapilamaz" demek degil. Sadece henuz dogru yolu bulmadin demek.
...
**Grok Note**: This mindset aligns with our phantom-like focus on core transfer without touching ~/.claude/. Use in sleuth, coroner, janitor, build-error-resolver. Original in ~/.claude/rules/phantom-mindset.md.