...
**Grok Note**: Enforced via our preflight, ledger (for TDD loops), verifier, hooks. See bundled/skills/test-enforcement. Original in ~/.claude/rules/safety-and-quality.md.