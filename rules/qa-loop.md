# Dev-QA Loop - Surekli Kalite Dongusu (Grok Port)
...
**Grok Note**: Enforced via our TaskLifecycleLedger (bounded, record_attempt, escalate), handoff skill, verifier 8-checks (incl ledger/handoff/friction/hook), hooks for on_bounded_loop_end. See bundled/skills/shared/task_lifecycle.py and implement/SKILL.md Production Contract. Original in ~/.claude/rules/qa-loop.md.