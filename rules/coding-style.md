# Coding Style & Patterns (Grok Port)
...
**Grok Note**: Use our compound + friction for style violations. Pre-flight includes this. See .grok/bundled/skills/ for examples. Original in ~/.claude/rules/coding-style.md (read-only).