# Claim Verification Rule (Grok Port)
...
## Enforcement
Use our factcheck-guard skill (available). Follow it. Pre-flight includes claim verification.

**Grok Note**: factcheck-guard skill in .grok/skills/ (from original). Enforced in linter, verifier, preflight. Original in ~/.claude/rules/claim-verification.md.