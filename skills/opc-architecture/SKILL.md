...
description: Opc Architecture (Grok Adapter). Grok-native port/adaptation. This skill provides the Opc Architecture capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Opc Architecture concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Opc Architecture (Grok Adapter)
...
## Role & Purpose
Opc Architecture patterns, best practices, and workflows.
