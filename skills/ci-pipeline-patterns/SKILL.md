...
description: Ci Pipeline Patterns (Grok Adapter). Grok-native port/adaptation. This skill provides the Ci Pipeline Patterns capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Ci Pipeline Patterns concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Ci Pipeline Patterns (Grok Adapter)
...
## Role & Purpose
Ci Pipeline Patterns patterns, best practices, and workflows.
