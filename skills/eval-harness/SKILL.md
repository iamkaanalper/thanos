---
name: eval-harness
description: Eval Harness (Grok Adapter). Grok-native port/adaptation. This skill provides the Eval Harness capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Eval Harness concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Eval Harness (Grok Adapter)
...
## Role & Purpose
Eval Harness patterns, best practices, and workflows.
