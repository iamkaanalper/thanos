...
description: Continuous Learning V2 (Grok Adapter). Grok-native port/adaptation. This skill provides the Continuous Learning V2 capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Continuous Learning V2 concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Continuous Learning V2 (Grok Adapter)
...
## Role & Purpose
Continuous Learning V2 patterns, best practices, and workflows.
