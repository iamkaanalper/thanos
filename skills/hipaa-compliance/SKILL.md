...
description: Hipaa Compliance (Grok Adapter). Grok-native port/adaptation. This skill provides the Hipaa Compliance capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Hipaa Compliance concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Hipaa Compliance (Grok Adapter)
...
## Role & Purpose
Hipaa Compliance patterns, best practices, and workflows.
