...
description: Api Versioning Patterns (Grok Adapter). Grok-native port/adaptation. This skill provides the Api Versioning Patterns capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Api Versioning Patterns concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Api Versioning Patterns (Grok Adapter)
...
## Role & Purpose
Api Versioning Patterns patterns, best practices, and workflows.
