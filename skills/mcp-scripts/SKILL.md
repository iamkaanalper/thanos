---
name: mcp-scripts
description: Mcp Scripts (Grok Adapter). Grok-native port/adaptation. This skill provides the Mcp Scripts capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Mcp Scripts concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Mcp Scripts (Grok Adapter)
...
## Role & Purpose
Mcp Scripts patterns, best practices, and workflows.
