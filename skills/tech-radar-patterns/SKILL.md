...
description: Tech Radar Patterns (Grok Adapter). Grok-native port/adaptation. This skill provides the Tech Radar Patterns capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Tech Radar Patterns concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Tech Radar Patterns (Grok Adapter)
...
## Role & Purpose
Tech Radar Patterns patterns, best practices, and workflows.
