---
name: create_handoff
description: Create Handoff (Grok Adapter). Grok-native port/adaptation. This skill provides the Create Handoff capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Create Handoff concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Create Handoff (Grok Adapter)
...
## Role & Purpose
Create Handoff patterns, best practices, and workflows.
