---
name: swift-patterns
description: Swift Patterns (Grok Adapter). Grok-native port/adaptation. This skill provides the Swift Patterns capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Swift Patterns concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Swift Patterns (Grok Adapter)
...
## Role & Purpose
Swift Patterns patterns, best practices, and workflows.
