...
description: Tdd Migration Pipeline (Grok Adapter). Grok-native port/adaptation. This skill provides the Tdd Migration Pipeline capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Tdd Migration Pipeline concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Tdd Migration Pipeline (Grok Adapter)
...
## Role & Purpose
Tdd Migration Pipeline patterns, best practices, and workflows.
