---
name: migrate
description: Migrate (Grok Adapter). Grok-native port/adaptation. This skill provides the Migrate capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Migrate concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Migrate (Grok Adapter)
...
## Role & Purpose
Migrate patterns, best practices, and workflows.
