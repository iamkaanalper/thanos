...
description: Workflow Router (Grok Adapter). Grok-native port/adaptation. This skill provides the Workflow Router capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Workflow Router concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Workflow Router (Grok Adapter)
...
## Role & Purpose
Workflow Router patterns, best practices, and workflows.
