...
description: Session Compression (Grok Adapter). Grok-native port/adaptation. This skill provides the Session Compression capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Session Compression concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Session Compression (Grok Adapter)
...
## Role & Purpose
Session Compression patterns, best practices, and workflows.
