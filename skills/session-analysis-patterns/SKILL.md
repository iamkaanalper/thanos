...
description: Session Analysis Patterns (Grok Adapter). Grok-native port/adaptation. This skill provides the Session Analysis Patterns capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Session Analysis Patterns concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Session Analysis Patterns (Grok Adapter)
...
## Role & Purpose
Session Analysis Patterns patterns, best practices, and workflows.
