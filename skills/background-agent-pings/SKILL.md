...
description: Background Agent Pings (Grok Adapter). Grok-native port/adaptation. This skill provides the Background Agent Pings capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Background Agent Pings concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Background Agent Pings (Grok Adapter)
...
## Role & Purpose
Background Agent Pings patterns, best practices, and workflows.
