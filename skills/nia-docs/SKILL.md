---
name: nia-docs
description: Nia Docs (Grok Adapter). Grok-native port/adaptation. This skill provides the Nia Docs capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Nia Docs concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Nia Docs (Grok Adapter)
...
## Role & Purpose
Nia Docs patterns, best practices, and workflows.
