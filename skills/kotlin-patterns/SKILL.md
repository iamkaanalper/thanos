...
description: Kotlin Patterns (Grok Adapter). Grok-native port/adaptation. This skill provides the Kotlin Patterns capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Kotlin Patterns concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Kotlin Patterns (Grok Adapter)
...
## Role & Purpose
Kotlin Patterns patterns, best practices, and workflows.
