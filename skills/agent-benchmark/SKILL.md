...
description: Agent Benchmark (Grok Adapter). Grok-native port/adaptation. This skill provides the Agent Benchmark capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Agent Benchmark concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Agent Benchmark (Grok Adapter)
...
## Role & Purpose
Agent Benchmark patterns, best practices, and workflows.
