---
name: research
description: Research (Grok Adapter). Grok-native port/adaptation. This skill provides the Research capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Research concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Research (Grok Adapter)
...
## Role & Purpose
Research patterns, best practices, and workflows.
