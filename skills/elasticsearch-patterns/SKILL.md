...
description: Elasticsearch Patterns (Grok Adapter). Grok-native port/adaptation. This skill provides the Elasticsearch Patterns capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Elasticsearch Patterns concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Elasticsearch Patterns (Grok Adapter)
...
## Role & Purpose
Elasticsearch Patterns patterns, best practices, and workflows.
