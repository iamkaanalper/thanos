---
name: loogle-search
description: Loogle Search (Grok Adapter). Grok-native port/adaptation. This skill provides the Loogle Search capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Loogle Search concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Loogle Search (Grok Adapter)
...
## Role & Purpose
Loogle Search patterns, best practices, and workflows.
