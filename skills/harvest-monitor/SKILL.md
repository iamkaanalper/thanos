...
description: Harvest Monitor (Grok Adapter). Grok-native port/adaptation. This skill provides the Harvest Monitor capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Harvest Monitor concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Harvest Monitor (Grok Adapter)
...
## Role & Purpose
Harvest Monitor patterns, best practices, and workflows.
