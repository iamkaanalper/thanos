---
name: search-tools
description: Search Tools (Grok Adapter). Grok-native port/adaptation. This skill provides the Search Tools capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Search Tools concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Search Tools (Grok Adapter)
...
## Role & Purpose
Search Tools patterns, best practices, and workflows.
