...
description: Swarm Optimization Patterns (Grok Adapter). Grok-native port/adaptation. This skill provides the Swarm Optimization Patterns capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Swarm Optimization Patterns concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Swarm Optimization Patterns (Grok Adapter)
...
## Role & Purpose
Swarm Optimization Patterns patterns, best practices, and workflows.
