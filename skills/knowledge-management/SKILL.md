...
description: Knowledge Management (Grok Adapter). Grok-native port/adaptation. This skill provides the Knowledge Management capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Knowledge Management concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Knowledge Management (Grok Adapter)
...
## Role & Purpose
Knowledge Management patterns, best practices, and workflows.
