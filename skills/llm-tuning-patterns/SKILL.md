...
description: Llm Tuning Patterns (Grok Adapter). Grok-native port/adaptation. This skill provides the Llm Tuning Patterns capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Llm Tuning Patterns concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Llm Tuning Patterns (Grok Adapter)
...
## Role & Purpose
Llm Tuning Patterns patterns, best practices, and workflows.
