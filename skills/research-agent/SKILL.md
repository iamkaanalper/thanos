---
name: research-agent
description: Research Agent (Grok Adapter). Grok-native port/adaptation. This skill provides the Research Agent capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Research Agent concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Research Agent (Grok Adapter)
...
## Role & Purpose
Research Agent patterns, best practices, and workflows.
