---
name: tdd-migrate
description: Tdd Migrate (Grok Adapter). Grok-native port/adaptation. This skill provides the Tdd Migrate capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Tdd Migrate concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Tdd Migrate (Grok Adapter)
...
## Role & Purpose
Tdd Migrate patterns, best practices, and workflows.
