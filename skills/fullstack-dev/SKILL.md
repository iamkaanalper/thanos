---
name: fullstack-dev
description: Fullstack Dev (Grok Adapter). Grok-native port/adaptation. This skill provides the Fullstack Dev capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Fullstack Dev concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Fullstack Dev (Grok Adapter)
...
## Role & Purpose
Fullstack Dev patterns, best practices, and workflows.
