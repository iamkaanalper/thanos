...
description: Variant Analysis (Grok Adapter). Grok-native port/adaptation. This skill provides the Variant Analysis capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Variant Analysis concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Variant Analysis (Grok Adapter)
...
## Role & Purpose
Variant Analysis patterns, best practices, and workflows.
