...
description: Recall Reasoning (Grok Adapter). Grok-native port/adaptation. This skill provides the Recall Reasoning capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Recall Reasoning concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Recall Reasoning (Grok Adapter)
...
## Role & Purpose
Recall Reasoning patterns, best practices, and workflows.
