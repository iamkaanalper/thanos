---
name: complete-skill
description: Complete Skill (Grok Adapter). Grok-native port/adaptation. This skill provides the Complete Skill capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Complete Skill concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Complete Skill (Grok Adapter)
...
## Role & Purpose
Complete Skill patterns, best practices, and workflows.
