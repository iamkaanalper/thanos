---
name: explore
description: Explore (Grok Adapter). Grok-native port/adaptation. This skill provides the Explore capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Explore concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Explore (Grok Adapter)
...
## Role & Purpose
Explore patterns, best practices, and workflows.
