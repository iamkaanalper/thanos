---
name: deep-interview
description: Deep Interview (Grok Adapter). Grok-native port/adaptation. This skill provides the Deep Interview capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Deep Interview concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Deep Interview (Grok Adapter)
...
## Role & Purpose
Deep Interview patterns, best practices, and workflows.
