---
name: agentica-sdk
description: Agentica Sdk (Grok Adapter). Grok-native port/adaptation. This skill provides the Agentica Sdk capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Agentica Sdk concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Agentica Sdk (Grok Adapter)
...
## Role & Purpose
Agentica Sdk patterns, best practices, and workflows.
