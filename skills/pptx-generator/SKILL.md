---
name: pptx-generator
description: Pptx Generator (Grok Adapter). Grok-native port/adaptation. This skill provides the Pptx Generator capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Pptx Generator concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Pptx Generator (Grok Adapter)
...
## Role & Purpose
Pptx Generator patterns, best practices, and workflows.
