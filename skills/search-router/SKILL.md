---
name: search-router
description: Search Router (Grok Adapter). Grok-native port/adaptation. This skill provides the Search Router capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Search Router concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Search Router (Grok Adapter)
...
## Role & Purpose
Search Router patterns, best practices, and workflows.
