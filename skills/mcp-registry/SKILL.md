---
name: mcp-registry
description: Mcp Registry (Grok Adapter). Grok-native port/adaptation. This skill provides the Mcp Registry capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Mcp Registry concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Mcp Registry (Grok Adapter)
...
## Role & Purpose
Mcp Registry patterns, best practices, and workflows.
