...
description: Understand Codebase (Grok Adapter). Grok-native port/adaptation. This skill provides the Understand Codebase capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Understand Codebase concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Understand Codebase (Grok Adapter)
...
## Role & Purpose
Understand Codebase patterns, best practices, and workflows.
