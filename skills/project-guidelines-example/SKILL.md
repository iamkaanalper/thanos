...
description: Project Guidelines Example (Grok Adapter). Grok-native port/adaptation. This skill provides the Project Guidelines Example capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Project Guidelines Example concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Project Guidelines Example (Grok Adapter)
...
## Role & Purpose
Project Guidelines Example patterns, best practices, and workflows.
