...
description: Prompt Engineering (Grok Adapter). Grok-native port/adaptation. This skill provides the Prompt Engineering capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Prompt Engineering concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Prompt Engineering (Grok Adapter)
...
## Role & Purpose
Prompt Engineering patterns, best practices, and workflows.
