...
description: Config Security Scan (Grok Adapter). Grok-native port/adaptation. This skill provides the Config Security Scan capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Config Security Scan concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Config Security Scan (Grok Adapter)
...
## Role & Purpose
Config Security Scan patterns, best practices, and workflows.
