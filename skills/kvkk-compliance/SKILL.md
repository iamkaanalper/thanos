...
description: Kvkk Compliance (Grok Adapter). Grok-native port/adaptation. This skill provides the Kvkk Compliance capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Kvkk Compliance concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Kvkk Compliance (Grok Adapter)
...
## Role & Purpose
Kvkk Compliance patterns, best practices, and workflows.
