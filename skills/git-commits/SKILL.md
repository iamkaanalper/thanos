---
name: git-commits
description: Git Commits (Grok Adapter). Grok-native port/adaptation. This skill provides the Git Commits capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Git Commits concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Git Commits (Grok Adapter)
...
## Role & Purpose
Git Commits patterns, best practices, and workflows.
