---
name: project-detect
description: Project Detect (Grok Adapter). Grok-native port/adaptation. This skill provides the Project Detect capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Project Detect concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Project Detect (Grok Adapter)
...
## Role & Purpose
Project Detect patterns, best practices, and workflows.
