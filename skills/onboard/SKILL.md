---
name: onboard
description: Onboard (Grok Adapter). Grok-native port/adaptation. This skill provides the Onboard capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Onboard concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Onboard (Grok Adapter)
...
## Role & Purpose
Onboard patterns, best practices, and workflows.
