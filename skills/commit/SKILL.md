---
name: commit
description: Commit (Grok Adapter). Grok-native port/adaptation. This skill provides the Commit capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Commit concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---
...
## Role & Purpose
Commit patterns, best practices, and workflows.
