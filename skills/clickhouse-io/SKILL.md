---
name: clickhouse-io
description: Clickhouse Io (Grok Adapter). Grok-native port/adaptation. This skill provides the Clickhouse Io capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Clickhouse Io concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Clickhouse Io (Grok Adapter)
...
## Role & Purpose
Clickhouse Io patterns, best practices, and workflows.
