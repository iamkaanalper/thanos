---
name: github-mcp
description: Github Mcp (Grok Adapter). Grok-native port/adaptation. This skill provides the Github Mcp capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Github Mcp concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Github Mcp (Grok Adapter)
...
## Role & Purpose
Github Mcp patterns, best practices, and workflows.
