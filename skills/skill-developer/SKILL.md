...
description: Skill Developer (Grok Adapter). Grok-native port/adaptation. This skill provides the Skill Developer capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Skill Developer concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Skill Developer (Grok Adapter)
...
## Role & Purpose
Skill Developer patterns, best practices, and workflows.
