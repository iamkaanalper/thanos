...
description: Github Actions Integration (Grok Adapter). Grok-native port/adaptation. This skill provides the Github Actions Integration capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Github Actions Integration concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Github Actions Integration (Grok Adapter)
...
## Role & Purpose
Github Actions Integration patterns, best practices, and workflows.
