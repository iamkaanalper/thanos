...
description: Harvest Structured (Grok Adapter). Grok-native port/adaptation. This skill provides the Harvest Structured capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Harvest Structured concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Harvest Structured (Grok Adapter)
...
## Role & Purpose
Harvest Structured patterns, best practices, and workflows.
