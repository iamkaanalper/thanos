...
description: Reverse Document (Grok Adapter). Grok-native port/adaptation. This skill provides the Reverse Document capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Reverse Document concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Reverse Document (Grok Adapter)
...
## Role & Purpose
Reverse Document patterns, best practices, and workflows.
