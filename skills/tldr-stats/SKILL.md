---
name: tldr-stats
description: Tldr Stats (Grok Adapter). Grok-native port/adaptation. This skill provides the Tldr Stats capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Tldr Stats concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Tldr Stats (Grok Adapter)
...
## Role & Purpose
Tldr Stats patterns, best practices, and workflows.
