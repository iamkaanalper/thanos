...
description: Router First Architecture (Grok Adapter). Grok-native port/adaptation. This skill provides the Router First Architecture capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Router First Architecture concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Router First Architecture (Grok Adapter)
...
## Role & Purpose
Router First Architecture patterns, best practices, and workflows.
