...
description: Product Analytics (Grok Adapter). Grok-native port/adaptation. This skill provides the Product Analytics capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Product Analytics concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Product Analytics (Grok Adapter)
...
## Role & Purpose
Product Analytics patterns, best practices, and workflows.
