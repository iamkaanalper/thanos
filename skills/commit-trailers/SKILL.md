...
description: Commit Trailers (Grok Adapter). Grok-native port/adaptation. This skill provides the Commit Trailers capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Commit Trailers concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Commit Trailers (Grok Adapter)
...
## Role & Purpose
Commit Trailers patterns, best practices, and workflows.
