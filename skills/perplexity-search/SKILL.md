...
description: Perplexity Search (Grok Adapter). Grok-native port/adaptation. This skill provides the Perplexity Search capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Perplexity Search concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Perplexity Search (Grok Adapter)
...
## Role & Purpose
Perplexity Search patterns, best practices, and workflows.
