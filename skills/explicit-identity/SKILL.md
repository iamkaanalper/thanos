...
description: Explicit Identity (Grok Adapter). Grok-native port/adaptation. This skill provides the Explicit Identity capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Explicit Identity concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Explicit Identity (Grok Adapter)
...
## Role & Purpose
Explicit Identity patterns, best practices, and workflows.
