---
name: modular-code
description: Modular Code (Grok Adapter). Grok-native port/adaptation. This skill provides the Modular Code capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Modular Code concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Modular Code (Grok Adapter)
...
## Role & Purpose
Modular Code patterns, best practices, and workflows.
