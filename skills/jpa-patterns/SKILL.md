---
name: jpa-patterns
description: Jpa Patterns (Grok Adapter). Grok-native port/adaptation. This skill provides the Jpa Patterns capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Jpa Patterns concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Jpa Patterns (Grok Adapter)
...
## Role & Purpose
Jpa Patterns patterns, best practices, and workflows.
