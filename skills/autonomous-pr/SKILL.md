---
name: autonomous-pr
description: Autonomous Pr (Grok Adapter). Grok-native port/adaptation. This skill provides the Autonomous Pr capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Autonomous Pr concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Autonomous Pr (Grok Adapter)
...
## Role & Purpose
Autonomous Pr patterns, best practices, and workflows.
