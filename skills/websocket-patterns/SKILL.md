...
description: Websocket Patterns (Grok Adapter). Grok-native port/adaptation. This skill provides the Websocket Patterns capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Websocket Patterns concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Websocket Patterns (Grok Adapter)
...
## Role & Purpose
Websocket Patterns patterns, best practices, and workflows.
