...
description: Strategic Compact (Grok Adapter). Grok-native port/adaptation. This skill provides the Strategic Compact capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Strategic Compact concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Strategic Compact (Grok Adapter)
...
## Role & Purpose
Strategic Compact patterns, best practices, and workflows.
