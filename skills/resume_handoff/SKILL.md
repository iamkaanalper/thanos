---
name: resume_handoff
description: Resume Handoff (Grok Adapter). Grok-native port/adaptation. This skill provides the Resume Handoff capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Resume Handoff concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Resume Handoff (Grok Adapter)
...
## Role & Purpose
Resume Handoff patterns, best practices, and workflows.
