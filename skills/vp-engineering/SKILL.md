---
name: vp-engineering
description: Vp Engineering (Grok Adapter). Grok-native port/adaptation. This skill provides the Vp Engineering capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Vp Engineering concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Vp Engineering (Grok Adapter)
...
## Role & Purpose
Vp Engineering patterns, best practices, and workflows.
