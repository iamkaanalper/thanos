...
description: Code Knowledge Graph (Grok Adapter). Grok-native port/adaptation. This skill provides the Code Knowledge Graph capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Code Knowledge Graph concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Code Knowledge Graph (Grok Adapter)
...
## Role & Purpose
Code Knowledge Graph patterns, best practices, and workflows.
