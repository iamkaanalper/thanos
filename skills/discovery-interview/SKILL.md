...
description: Discovery Interview (Grok Adapter). Grok-native port/adaptation. This skill provides the Discovery Interview capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Discovery Interview concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Discovery Interview (Grok Adapter)
...
## Role & Purpose
Discovery Interview patterns, best practices, and workflows.
