---
name: minimax-docx
description: Minimax Docx (Grok Adapter). Grok-native port/adaptation. This skill provides the Minimax Docx capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Minimax Docx concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Minimax Docx (Grok Adapter)
...
## Role & Purpose
Minimax Docx patterns, best practices, and workflows.
