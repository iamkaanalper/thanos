...
description: Repo Research Analyst (Grok Adapter). Grok-native port/adaptation. This skill provides the Repo Research Analyst capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Repo Research Analyst concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Repo Research Analyst (Grok Adapter)
...
## Role & Purpose
Repo Research Analyst patterns, best practices, and workflows.
