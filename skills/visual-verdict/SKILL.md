---
name: visual-verdict
description: Visual Verdict (Grok Adapter). Grok-native port/adaptation. This skill provides the Visual Verdict capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Visual Verdict concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Visual Verdict (Grok Adapter)
...
## Role & Purpose
Visual Verdict patterns, best practices, and workflows.
