...
description: Component Library Patterns (Grok Adapter). Grok-native port/adaptation. This skill provides the Component Library Patterns capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Component Library Patterns concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Component Library Patterns (Grok Adapter)
...
## Role & Purpose
Component Library Patterns patterns, best practices, and workflows.
