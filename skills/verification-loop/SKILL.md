...
description: Verification Loop (Grok Adapter). Grok-native port/adaptation. This skill provides the Verification Loop capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Verification Loop concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Verification Loop (Grok Adapter)
...
## Role & Purpose
Verification Loop patterns, best practices, and workflows.
