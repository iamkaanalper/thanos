---
name: hooks
description: Hooks (Grok Adapter). Grok-native port/adaptation. This skill provides the Hooks capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Hooks concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---
...
## Role & Purpose
Hooks patterns, best practices, and workflows.
