...
description: Search Hierarchy (Grok Adapter). Grok-native port/adaptation. This skill provides the Search Hierarchy capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Search Hierarchy concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Search Hierarchy (Grok Adapter)
...
## Role & Purpose
Search Hierarchy patterns, best practices, and workflows.
