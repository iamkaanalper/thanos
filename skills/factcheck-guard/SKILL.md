...
description: Factcheck Guard (Grok Adapter). Grok-native port/adaptation. This skill provides the Factcheck Guard capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Factcheck Guard concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Factcheck Guard (Grok Adapter)
...
## Role & Purpose
Factcheck Guard patterns, best practices, and workflows.
