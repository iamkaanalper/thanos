...
description: Email Infrastructure (Grok Adapter). Grok-native port/adaptation. This skill provides the Email Infrastructure capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Email Infrastructure concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Email Infrastructure (Grok Adapter)
...
## Role & Purpose
Email Infrastructure patterns, best practices, and workflows.
