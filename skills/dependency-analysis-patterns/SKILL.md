...
description: Dependency Analysis Patterns (Grok Adapter). Grok-native port/adaptation. This skill provides the Dependency Analysis Patterns capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Dependency Analysis Patterns concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Dependency Analysis Patterns (Grok Adapter)
...
## Role & Purpose
Dependency Analysis Patterns patterns, best practices, and workflows.
