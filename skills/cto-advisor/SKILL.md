---
name: cto-advisor
description: Cto Advisor (Grok Adapter). Grok-native port/adaptation. This skill provides the Cto Advisor capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Cto Advisor concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Cto Advisor (Grok Adapter)
...
## Role & Purpose
Cto Advisor patterns, best practices, and workflows.
