...
description: Incident Response Patterns (Grok Adapter). Grok-native port/adaptation. This skill provides the Incident Response Patterns capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Incident Response Patterns concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Incident Response Patterns (Grok Adapter)
...
## Role & Purpose
Incident Response Patterns patterns, best practices, and workflows.
