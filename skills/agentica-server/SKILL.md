...
description: Agentica Server (Grok Adapter). Grok-native port/adaptation. This skill provides the Agentica Server capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Agentica Server concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Agentica Server (Grok Adapter)
...
## Role & Purpose
Agentica Server patterns, best practices, and workflows.
