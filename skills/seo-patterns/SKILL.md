---
name: seo-patterns
description: Seo Patterns (Grok Adapter). Grok-native port/adaptation. This skill provides the Seo Patterns capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Seo Patterns concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Seo Patterns (Grok Adapter)
...
## Role & Purpose
Seo Patterns patterns, best practices, and workflows.
