...
description: No Polling Agents (Grok Adapter). Grok-native port/adaptation. This skill provides the No Polling Agents capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves No Polling Agents concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# No Polling Agents (Grok Adapter)
...
## Role & Purpose
No Polling Agents patterns, best practices, and workflows.
