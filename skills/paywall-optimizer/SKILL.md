...
description: Paywall Optimizer (Grok Adapter). Grok-native port/adaptation. This skill provides the Paywall Optimizer capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Paywall Optimizer concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Paywall Optimizer (Grok Adapter)
...
## Role & Purpose
Paywall Optimizer patterns, best practices, and workflows.
