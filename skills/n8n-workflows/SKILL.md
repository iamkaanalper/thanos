---
name: n8n-workflows
description: N8N Workflows (Grok Adapter). Grok-native port/adaptation. This skill provides the N8N Workflows capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves N8N Workflows concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# N8N Workflows (Grok Adapter)
...
## Role & Purpose
N8N Workflows patterns, best practices, and workflows.
