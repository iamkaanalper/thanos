...
description: Handoff Templates (Grok Adapter). Grok-native port/adaptation. This skill provides the Handoff Templates capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Handoff Templates concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Handoff Templates (Grok Adapter)
...
## Role & Purpose
Handoff Templates patterns, best practices, and workflows.
