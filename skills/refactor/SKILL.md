---
name: refactor
description: Refactor (Grok Adapter). Grok-native port/adaptation. This skill provides the Refactor capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Refactor concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Refactor (Grok Adapter)
...
## Role & Purpose
Refactor patterns, best practices, and workflows.
