...
description: Ai Slop Cleaner (Grok Adapter). Grok-native port/adaptation. This skill provides the Ai Slop Cleaner capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Ai Slop Cleaner concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Ai Slop Cleaner (Grok Adapter)
...
## Role & Purpose
Ai Slop Cleaner patterns, best practices, and workflows.
