...
description: Content Strategy (Grok Adapter). Grok-native port/adaptation. This skill provides the Content Strategy capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Content Strategy concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Content Strategy (Grok Adapter)
...
## Role & Purpose
Content Strategy patterns, best practices, and workflows.
