---
name: tldr-cli
description: Tldr Cli (Grok Adapter). Grok-native port/adaptation. This skill provides the Tldr Cli capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Tldr Cli concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Tldr Cli (Grok Adapter)
...
## Role & Purpose
Tldr Cli patterns, best practices, and workflows.
