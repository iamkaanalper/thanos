...
description: Environment Triage (Grok Adapter). Grok-native port/adaptation. This skill provides the Environment Triage capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Environment Triage concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Environment Triage (Grok Adapter)
...
## Role & Purpose
Environment Triage patterns, best practices, and workflows.
