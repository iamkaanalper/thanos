...
description: Accessibility Patterns (Grok Adapter). Grok-native port/adaptation. This skill provides the Accessibility Patterns capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Accessibility Patterns concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Accessibility Patterns (Grok Adapter)
...
## Role & Purpose
Accessibility Patterns patterns, best practices, and workflows.
