---
name: no-task-output
description: No Task Output (Grok Adapter). Grok-native port/adaptation. This skill provides the No Task Output capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves No Task Output concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# No Task Output (Grok Adapter)
...
## Role & Purpose
No Task Output patterns, best practices, and workflows.
