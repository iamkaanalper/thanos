...
description: Differential Review (Grok Adapter). Grok-native port/adaptation. This skill provides the Differential Review capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Differential Review concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Differential Review (Grok Adapter)
...
## Role & Purpose
Differential Review patterns, best practices, and workflows.
