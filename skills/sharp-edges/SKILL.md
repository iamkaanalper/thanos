---
name: sharp-edges
description: Sharp Edges (Grok Adapter). Grok-native port/adaptation. This skill provides the Sharp Edges capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Sharp Edges concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Sharp Edges (Grok Adapter)
...
## Role & Purpose
Sharp Edges patterns, best practices, and workflows.
