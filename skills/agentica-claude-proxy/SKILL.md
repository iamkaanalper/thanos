...
description: Agentica Claude Proxy (Grok Adapter). Grok-native port/adaptation. This skill provides the Agentica Claude Proxy capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Agentica Claude Proxy concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Agentica Claude Proxy (Grok Adapter)
...
## Role & Purpose
Agentica Claude Proxy patterns, best practices, and workflows.
