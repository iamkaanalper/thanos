---
name: minimax-pdf
description: Minimax Pdf (Grok Adapter). Grok-native port/adaptation. This skill provides the Minimax Pdf capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Minimax Pdf concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Minimax Pdf (Grok Adapter)
...
## Role & Purpose
Minimax Pdf patterns, best practices, and workflows.
