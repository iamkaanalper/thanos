---
name: ci-cd-pipeline
description: Ci Cd Pipeline (Grok Adapter). Grok-native port/adaptation. This skill provides the Ci Cd Pipeline capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Ci Cd Pipeline concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Ci Cd Pipeline (Grok Adapter)
...
## Role & Purpose
Ci Cd Pipeline patterns, best practices, and workflows.
