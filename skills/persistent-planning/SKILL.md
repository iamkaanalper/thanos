...
description: Persistent Planning (Grok Adapter). Grok-native port/adaptation. This skill provides the Persistent Planning capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Persistent Planning concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Persistent Planning (Grok Adapter)
...
## Role & Purpose
Persistent Planning patterns, best practices, and workflows.
