...
description: Async Repl Protocol (Grok Adapter). Grok-native port/adaptation. This skill provides the Async Repl Protocol capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Async Repl Protocol concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Async Repl Protocol (Grok Adapter)
...
## Role & Purpose
Async Repl Protocol patterns, best practices, and workflows.
