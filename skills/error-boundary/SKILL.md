---
name: error-boundary
description: Error Boundary (Grok Adapter). Grok-native port/adaptation. This skill provides the Error Boundary capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Error Boundary concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Error Boundary (Grok Adapter)
...
## Role & Purpose
Error Boundary patterns, best practices, and workflows.
