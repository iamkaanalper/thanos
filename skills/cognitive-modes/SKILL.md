...
description: Cognitive Modes (Grok Adapter). Grok-native port/adaptation. This skill provides the Cognitive Modes capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Cognitive Modes concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Cognitive Modes (Grok Adapter)
...
## Role & Purpose
Cognitive Modes patterns, best practices, and workflows.
