---
name: morph-search
description: Morph Search (Grok Adapter). Grok-native port/adaptation. This skill provides the Morph Search capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Morph Search concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Morph Search (Grok Adapter)
...
## Role & Purpose
Morph Search patterns, best practices, and workflows.
