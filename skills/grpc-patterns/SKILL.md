---
name: grpc-patterns
description: Grpc Patterns (Grok Adapter). Grok-native port/adaptation. This skill provides the Grpc Patterns capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Grpc Patterns concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Grpc Patterns (Grok Adapter)
...
## Role & Purpose
Grpc Patterns patterns, best practices, and workflows.
