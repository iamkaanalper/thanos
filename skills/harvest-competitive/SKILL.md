...
description: Harvest Competitive (Grok Adapter). Grok-native port/adaptation. This skill provides the Harvest Competitive capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Harvest Competitive concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Harvest Competitive (Grok Adapter)
...
## Role & Purpose
Harvest Competitive patterns, best practices, and workflows.
