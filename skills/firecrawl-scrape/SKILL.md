...
description: Firecrawl Scrape (Grok Adapter). Grok-native port/adaptation. This skill provides the Firecrawl Scrape capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Firecrawl Scrape concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Firecrawl Scrape (Grok Adapter)
...
## Role & Purpose
Firecrawl Scrape patterns, best practices, and workflows.
