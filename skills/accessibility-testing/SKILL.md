...
description: Accessibility Testing (Grok Adapter). Grok-native port/adaptation. This skill provides the Accessibility Testing capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Accessibility Testing concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Accessibility Testing (Grok Adapter)
...
## Role & Purpose
Accessibility Testing patterns, best practices, and workflows.
