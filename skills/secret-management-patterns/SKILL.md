...
description: Secret Management Patterns (Grok Adapter). Grok-native port/adaptation. This skill provides the Secret Management Patterns capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Secret Management Patterns concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Secret Management Patterns (Grok Adapter)
...
## Role & Purpose
Secret Management Patterns patterns, best practices, and workflows.
