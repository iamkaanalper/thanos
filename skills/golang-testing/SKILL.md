---
name: golang-testing
description: Golang Testing (Grok Adapter). Grok-native port/adaptation. This skill provides the Golang Testing capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Golang Testing concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Golang Testing (Grok Adapter)
...
## Role & Purpose
Golang Testing patterns, best practices, and workflows.
