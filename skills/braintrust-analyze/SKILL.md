...
description: Braintrust Analyze (Grok Adapter). Grok-native port/adaptation. This skill provides the Braintrust Analyze capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Braintrust Analyze concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Braintrust Analyze (Grok Adapter)
...
## Role & Purpose
Braintrust Analyze patterns, best practices, and workflows.
