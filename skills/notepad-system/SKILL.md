---
name: notepad-system
description: Notepad System (Grok Adapter). Grok-native port/adaptation. This skill provides the Notepad System capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Notepad System concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Notepad System (Grok Adapter)
...
## Role & Purpose
Notepad System patterns, best practices, and workflows.
