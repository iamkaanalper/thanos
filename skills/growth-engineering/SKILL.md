...
description: Growth Engineering (Grok Adapter). Grok-native port/adaptation. This skill provides the Growth Engineering capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Growth Engineering concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Growth Engineering (Grok Adapter)
...
## Role & Purpose
Growth Engineering patterns, best practices, and workflows.
