...
description: Developer Relations (Grok Adapter). Grok-native port/adaptation. This skill provides the Developer Relations capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Developer Relations concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Developer Relations (Grok Adapter)
...
## Role & Purpose
Developer Relations patterns, best practices, and workflows.
