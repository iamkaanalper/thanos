---
name: pint-compute
description: Pint Compute (Grok Adapter). Grok-native port/adaptation. This skill provides the Pint Compute capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Pint Compute concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Pint Compute (Grok Adapter)
...
## Role & Purpose
Pint Compute patterns, best practices, and workflows.
