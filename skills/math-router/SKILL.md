---
name: math-router
description: Math Router (Grok Adapter). Grok-native port/adaptation. This skill provides the Math Router capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Math Router concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Math Router (Grok Adapter)
...
## Role & Purpose
Math Router patterns, best practices, and workflows.
