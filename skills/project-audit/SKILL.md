---
name: project-audit
description: Project Audit (Grok Adapter). Grok-native port/adaptation. This skill provides the Project Audit capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Project Audit concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Project Audit (Grok Adapter)
...
## Role & Purpose
Project Audit patterns, best practices, and workflows.
