---
name: premortem
description: Premortem (Grok Adapter). Grok-native port/adaptation. This skill provides the Premortem capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Premortem concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Premortem (Grok Adapter)
...
## Role & Purpose
Premortem patterns, best practices, and workflows.
