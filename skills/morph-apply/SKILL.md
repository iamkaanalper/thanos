---
name: morph-apply
description: Morph Apply (Grok Adapter). Grok-native port/adaptation. This skill provides the Morph Apply capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Morph Apply concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Morph Apply (Grok Adapter)
...
## Role & Purpose
Morph Apply patterns, best practices, and workflows.
