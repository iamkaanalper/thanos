---
name: tldr-code
description: Tldr Code (Grok Adapter). Grok-native port/adaptation. This skill provides the Tldr Code capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Tldr Code concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Tldr Code (Grok Adapter)
...
## Role & Purpose
Tldr Code patterns, best practices, and workflows.
