---
name: fix
description: Fix (Grok Adapter). Grok-native port/adaptation. This skill provides the Fix capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Fix concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---
...
## Role & Purpose
Fix patterns, best practices, and workflows.
