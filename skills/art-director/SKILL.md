---
name: art-director
description: Art Director (Grok Adapter). Grok-native port/adaptation. This skill provides the Art Director capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Art Director concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Art Director (Grok Adapter)
...
## Role & Purpose
Art Director patterns, best practices, and workflows.
