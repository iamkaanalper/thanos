---
name: remember
description: Remember (Grok Adapter). Grok-native port/adaptation. This skill provides the Remember capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Remember concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Remember (Grok Adapter)
...
## Role & Purpose
Remember patterns, best practices, and workflows.
