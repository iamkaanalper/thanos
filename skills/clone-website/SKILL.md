---
name: clone-website
description: Clone Website (Grok Adapter). Grok-native port/adaptation. This skill provides the Clone Website capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Clone Website concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Clone Website (Grok Adapter)
...
## Role & Purpose
Clone Website patterns, best practices, and workflows.
