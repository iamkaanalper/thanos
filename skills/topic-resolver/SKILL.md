---
name: topic-resolver
description: Topic Resolver (Grok Adapter). Grok-native port/adaptation. This skill provides the Topic Resolver capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Topic Resolver concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Topic Resolver (Grok Adapter)
...
## Role & Purpose
Topic Resolver patterns, best practices, and workflows.
