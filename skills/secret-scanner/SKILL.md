---
name: secret-scanner
description: Secret Scanner (Grok Adapter). Grok-native port/adaptation. This skill provides the Secret Scanner capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Secret Scanner concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Secret Scanner (Grok Adapter)
...
## Role & Purpose
Secret Scanner patterns, best practices, and workflows.
