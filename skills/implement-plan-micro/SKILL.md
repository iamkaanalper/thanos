...
description: Implement Plan Micro (Grok Adapter). Grok-native port/adaptation. This skill provides the Implement Plan Micro capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Implement Plan Micro concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Implement Plan Micro (Grok Adapter)
...
## Role & Purpose
Implement Plan Micro patterns, best practices, and workflows.
