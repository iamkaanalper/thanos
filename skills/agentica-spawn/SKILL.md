---
name: agentica-spawn
description: Agentica Spawn (Grok Adapter). Grok-native port/adaptation. This skill provides the Agentica Spawn capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Agentica Spawn concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Agentica Spawn (Grok Adapter)
...
## Role & Purpose
Agentica Spawn patterns, best practices, and workflows.
