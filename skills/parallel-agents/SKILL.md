...
description: Parallel Agents (Grok Adapter). Grok-native port/adaptation. This skill provides the Parallel Agents capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Parallel Agents concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Parallel Agents (Grok Adapter)
...
## Role & Purpose
Parallel Agents patterns, best practices, and workflows.
