---
name: django-tdd
description: Django Tdd (Grok Adapter). Grok-native port/adaptation. This skill provides the Django Tdd capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Django Tdd concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Django Tdd (Grok Adapter)
...
## Role & Purpose
Django Tdd patterns, best practices, and workflows.
