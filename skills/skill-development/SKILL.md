...
description: Skill Development (Grok Adapter). Grok-native port/adaptation. This skill provides the Skill Development capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Skill Development concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Skill Development (Grok Adapter)
...
## Role & Purpose
Skill Development patterns, best practices, and workflows.
