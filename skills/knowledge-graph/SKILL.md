...
description: Knowledge Graph (Grok Adapter). Grok-native port/adaptation. This skill provides the Knowledge Graph capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Knowledge Graph concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Knowledge Graph (Grok Adapter)
...
## Role & Purpose
Knowledge Graph patterns, best practices, and workflows.
