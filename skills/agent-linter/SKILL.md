---
name: agent-linter
description: Agent Linter (Grok Adapter). Grok-native port/adaptation. This skill provides the Agent Linter capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Agent Linter concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Agent Linter (Grok Adapter)
...
## Role & Purpose
Agent Linter patterns, best practices, and workflows.
