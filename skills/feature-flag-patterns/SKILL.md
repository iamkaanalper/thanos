...
description: Feature Flag Patterns (Grok Adapter). Grok-native port/adaptation. This skill provides the Feature Flag Patterns capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Feature Flag Patterns concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Feature Flag Patterns (Grok Adapter)
...
## Role & Purpose
Feature Flag Patterns patterns, best practices, and workflows.
