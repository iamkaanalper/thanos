---
name: pyxel-patterns
description: Pyxel Patterns (Grok Adapter). Grok-native port/adaptation. This skill provides the Pyxel Patterns capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Pyxel Patterns concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Pyxel Patterns (Grok Adapter)
...
## Role & Purpose
Pyxel Patterns patterns, best practices, and workflows.
