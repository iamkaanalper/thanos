...
description: Subscription Pricing (Grok Adapter). Grok-native port/adaptation. This skill provides the Subscription Pricing capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Subscription Pricing concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Subscription Pricing (Grok Adapter)
...
## Role & Purpose
Subscription Pricing patterns, best practices, and workflows.
