...
description: Smart Model Routing (Grok Adapter). Grok-native port/adaptation. This skill provides the Smart Model Routing capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Smart Model Routing concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Smart Model Routing (Grok Adapter)
...
## Role & Purpose
Smart Model Routing patterns, best practices, and workflows.
