---
name: rag-patterns
description: Rag Patterns (Grok Adapter). Grok-native port/adaptation. This skill provides the Rag Patterns capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Rag Patterns concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Rag Patterns (Grok Adapter)
...
## Role & Purpose
Rag Patterns patterns, best practices, and workflows.
