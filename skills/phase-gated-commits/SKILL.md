...
description: Phase Gated Commits (Grok Adapter). Grok-native port/adaptation. This skill provides the Phase Gated Commits capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Phase Gated Commits concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Phase Gated Commits (Grok Adapter)
...
## Role & Purpose
Phase Gated Commits patterns, best practices, and workflows.
