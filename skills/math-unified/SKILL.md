---
name: math-unified
description: Math Unified (Grok Adapter). Grok-native port/adaptation. This skill provides the Math Unified capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Math Unified concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Math Unified (Grok Adapter)
...
## Role & Purpose
Math Unified patterns, best practices, and workflows.
