---
name: fp-check
description: Fp Check (Grok Adapter). Grok-native port/adaptation. This skill provides the Fp Check capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Fp Check concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Fp Check (Grok Adapter)
...
## Role & Purpose
Fp Check patterns, best practices, and workflows.
