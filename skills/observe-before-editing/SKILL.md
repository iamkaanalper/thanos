...
description: Observe Before Editing (Grok Adapter). Grok-native port/adaptation. This skill provides the Observe Before Editing capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Observe Before Editing concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Observe Before Editing (Grok Adapter)
...
## Role & Purpose
Observe Before Editing patterns, best practices, and workflows.
