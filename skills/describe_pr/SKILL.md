---
name: describe_pr
description: Describe Pr (Grok Adapter). Grok-native port/adaptation. This skill provides the Describe Pr capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Describe Pr concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Describe Pr (Grok Adapter)
...
## Role & Purpose
Describe Pr patterns, best practices, and workflows.
