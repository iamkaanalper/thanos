---
name: gate-check
description: Gate Check (Grok Adapter). Grok-native port/adaptation. This skill provides the Gate Check capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Gate Check concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Gate Check (Grok Adapter)
...
## Role & Purpose
Gate Check patterns, best practices, and workflows.
