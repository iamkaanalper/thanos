---
name: frontend-dev
description: Frontend Dev (Grok Adapter). Grok-native port/adaptation. This skill provides the Frontend Dev capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Frontend Dev concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Frontend Dev (Grok Adapter)
...
## Role & Purpose
Frontend Dev patterns, best practices, and workflows.
