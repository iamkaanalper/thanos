...
description: Coding Standards (Grok Adapter). Grok-native port/adaptation. This skill provides the Coding Standards capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Coding Standards concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Coding Standards (Grok Adapter)
...
## Role & Purpose
Coding Standards patterns, best practices, and workflows.
