...
description: Design System Generator (Grok Adapter). Grok-native port/adaptation. This skill provides the Design System Generator capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Design System Generator concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Design System Generator (Grok Adapter)
...
## Role & Purpose
Design System Generator patterns, best practices, and workflows.
