...
description: Agentica Infrastructure (Grok Adapter). Grok-native port/adaptation. This skill provides the Agentica Infrastructure capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Agentica Infrastructure concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Agentica Infrastructure (Grok Adapter)
...
## Role & Purpose
Agentica Infrastructure patterns, best practices, and workflows.
