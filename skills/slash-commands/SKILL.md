---
name: slash-commands
description: Slash Commands (Grok Adapter). Grok-native port/adaptation. This skill provides the Slash Commands capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Slash Commands concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Slash Commands (Grok Adapter)
...
## Role & Purpose
Slash Commands patterns, best practices, and workflows.
