---
name: ast-grep-find
description: Ast Grep Find (Grok Adapter). Grok-native port/adaptation. This skill provides the Ast Grep Find capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Ast Grep Find concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Ast Grep Find (Grok Adapter)
...
## Role & Purpose
Ast Grep Find patterns, best practices, and workflows.
