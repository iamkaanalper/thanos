---
name: hook-developer
description: Hook Developer (Grok Adapter). Grok-native port/adaptation. This skill provides the Hook Developer capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Hook Developer concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Hook Developer (Grok Adapter)
...
## Role & Purpose
Hook Developer patterns, best practices, and workflows.
