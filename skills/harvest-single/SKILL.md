---
name: harvest-single
description: Harvest Single (Grok Adapter). Grok-native port/adaptation. This skill provides the Harvest Single capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Harvest Single concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Harvest Single (Grok Adapter)
...
## Role & Purpose
Harvest Single patterns, best practices, and workflows.
