...
description: Parallel Agent Contracts (Grok Adapter). Grok-native port/adaptation. This skill provides the Parallel Agent Contracts capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Parallel Agent Contracts concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Parallel Agent Contracts (Grok Adapter)
...
## Role & Purpose
Parallel Agent Contracts patterns, best practices, and workflows.
