...
description: Content Marketing (Grok Adapter). Grok-native port/adaptation. This skill provides the Content Marketing capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Content Marketing concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Content Marketing (Grok Adapter)
...
## Role & Purpose
Content Marketing patterns, best practices, and workflows.
