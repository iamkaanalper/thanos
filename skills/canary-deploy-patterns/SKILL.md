...
description: Canary Deploy Patterns (Grok Adapter). Grok-native port/adaptation. This skill provides the Canary Deploy Patterns capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Canary Deploy Patterns concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Canary Deploy Patterns (Grok Adapter)
...
## Role & Purpose
Canary Deploy Patterns patterns, best practices, and workflows.
