...
description: Django Verification (Grok Adapter). Grok-native port/adaptation. This skill provides the Django Verification capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Django Verification concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Django Verification (Grok Adapter)
...
## Role & Purpose
Django Verification patterns, best practices, and workflows.
