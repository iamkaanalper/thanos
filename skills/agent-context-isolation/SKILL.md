...
description: Agent Context Isolation (Grok Adapter). Grok-native port/adaptation. This skill provides the Agent Context Isolation capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Agent Context Isolation concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Agent Context Isolation (Grok Adapter)
...
## Role & Purpose
Agent Context Isolation patterns, best practices, and workflows.
