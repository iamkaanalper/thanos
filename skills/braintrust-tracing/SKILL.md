...
description: Braintrust Tracing (Grok Adapter). Grok-native port/adaptation. This skill provides the Braintrust Tracing capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Braintrust Tracing concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Braintrust Tracing (Grok Adapter)
...
## Role & Purpose
Braintrust Tracing patterns, best practices, and workflows.
