...
description: Agentica Prompts (Grok Adapter). Grok-native port/adaptation. This skill provides the Agentica Prompts capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Agentica Prompts concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Agentica Prompts (Grok Adapter)
...
## Role & Purpose
Agentica Prompts patterns, best practices, and workflows.
