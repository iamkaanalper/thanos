---
name: cli-reference
description: Cli Reference (Grok Adapter). Grok-native port/adaptation. This skill provides the Cli Reference capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Cli Reference concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Cli Reference (Grok Adapter)
...
## Role & Purpose
Cli Reference patterns, best practices, and workflows.
