...
description: Plan Documentation (Grok Adapter). Grok-native port/adaptation. This skill provides the Plan Documentation capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Plan Documentation concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Plan Documentation (Grok Adapter)
...
## Role & Purpose
Plan Documentation patterns, best practices, and workflows.
