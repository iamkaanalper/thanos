---
name: reference-sdk
description: Reference Sdk (Grok Adapter). Grok-native port/adaptation. This skill provides the Reference Sdk capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Reference Sdk concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Reference Sdk (Grok Adapter)
...
## Role & Purpose
Reference Sdk patterns, best practices, and workflows.
