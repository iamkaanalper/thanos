---
name: tldr-deep
description: Tldr Deep (Grok Adapter). Grok-native port/adaptation. This skill provides the Tldr Deep capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Tldr Deep concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Tldr Deep (Grok Adapter)
...
## Role & Purpose
Tldr Deep patterns, best practices, and workflows.
