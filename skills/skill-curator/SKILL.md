---
name: skill-curator
description: Skill Curator (Grok Adapter). Grok-native port/adaptation. This skill provides the Skill Curator capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Skill Curator concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Skill Curator (Grok Adapter)
...
## Role & Purpose
Skill Curator patterns, best practices, and workflows.
