...
description: Browser Debugging (Grok Adapter). Grok-native port/adaptation. This skill provides the Browser Debugging capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Browser Debugging concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Browser Debugging (Grok Adapter)
...
## Role & Purpose
Browser Debugging patterns, best practices, and workflows.
