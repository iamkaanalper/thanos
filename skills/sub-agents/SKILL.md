---
name: sub-agents
description: Sub Agents (Grok Adapter). Grok-native port/adaptation. This skill provides the Sub Agents capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Sub Agents concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Sub Agents (Grok Adapter)
...
## Role & Purpose
Sub Agents patterns, best practices, and workflows.
