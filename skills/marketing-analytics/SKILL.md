...
description: Marketing Analytics (Grok Adapter). Grok-native port/adaptation. This skill provides the Marketing Analytics capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Marketing Analytics concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Marketing Analytics (Grok Adapter)
...
## Role & Purpose
Marketing Analytics patterns, best practices, and workflows.
