...
description: Soc2 Compliance (Grok Adapter). Grok-native port/adaptation. This skill provides the Soc2 Compliance capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Soc2 Compliance concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Soc2 Compliance (Grok Adapter)
...
## Role & Purpose
Soc2 Compliance patterns, best practices, and workflows.
