---
name: tldr-router
description: Tldr Router (Grok Adapter). Grok-native port/adaptation. This skill provides the Tldr Router capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Tldr Router concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Tldr Router (Grok Adapter)
...
## Role & Purpose
Tldr Router patterns, best practices, and workflows.
