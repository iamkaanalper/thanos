...
description: Circuit Breaker (Grok Adapter). Grok-native port/adaptation. This skill provides the Circuit Breaker capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Circuit Breaker concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Circuit Breaker (Grok Adapter)
...
## Role & Purpose
Circuit Breaker patterns, best practices, and workflows.
