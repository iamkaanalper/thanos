...
description: Springboot Patterns (Grok Adapter). Grok-native port/adaptation. This skill provides the Springboot Patterns capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Springboot Patterns concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Springboot Patterns (Grok Adapter)
...
## Role & Purpose
Springboot Patterns patterns, best practices, and workflows.
