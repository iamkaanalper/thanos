...
description: Server Components (Grok Adapter). Grok-native port/adaptation. This skill provides the Server Components capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Server Components concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Server Components (Grok Adapter)
...
## Role & Purpose
Server Components patterns, best practices, and workflows.
