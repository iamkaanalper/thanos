...
description: Diff Review Strategy (Grok Adapter). Grok-native port/adaptation. This skill provides the Diff Review Strategy capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Diff Review Strategy concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Diff Review Strategy (Grok Adapter)
...
## Role & Purpose
Diff Review Strategy patterns, best practices, and workflows.
