---
name: validate-agent
description: Validate Agent (Grok Adapter). Grok-native port/adaptation. This skill provides the Validate Agent capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Validate Agent concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Validate Agent (Grok Adapter)
...
## Role & Purpose
Validate Agent patterns, best practices, and workflows.
