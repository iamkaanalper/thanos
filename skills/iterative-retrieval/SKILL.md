...
description: Iterative Retrieval (Grok Adapter). Grok-native port/adaptation. This skill provides the Iterative Retrieval capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Iterative Retrieval concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Iterative Retrieval (Grok Adapter)
...
## Role & Purpose
Iterative Retrieval patterns, best practices, and workflows.
