---
name: achievements
description: Achievements (Grok Adapter). Grok-native port/adaptation. This skill provides the Achievements capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Achievements concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Achievements (Grok Adapter)
...
## Role & Purpose
Achievements patterns, best practices, and workflows.
