---
name: ui-ux-patterns
description: Ui Ux Patterns (Grok Adapter). Grok-native port/adaptation. This skill provides the Ui Ux Patterns capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Ui Ux Patterns concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Ui Ux Patterns (Grok Adapter)
...
## Role & Purpose
Ui Ux Patterns patterns, best practices, and workflows.
