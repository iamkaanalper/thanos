---
name: implement-task
description: Implement Task (Grok Adapter). Grok-native port/adaptation. This skill provides the Implement Task capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Implement Task concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Implement Task (Grok Adapter)
...
## Role & Purpose
Implement Task patterns, best practices, and workflows.
