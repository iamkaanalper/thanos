---
name: release
description: Release (Grok Adapter). Grok-native port/adaptation. This skill provides the Release capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Release concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Release (Grok Adapter)
...
## Role & Purpose
Release patterns, best practices, and workflows.
