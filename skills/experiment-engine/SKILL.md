...
description: Experiment Engine (Grok Adapter). Grok-native port/adaptation. This skill provides the Experiment Engine capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Experiment Engine concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Experiment Engine (Grok Adapter)
...
## Role & Purpose
Experiment Engine patterns, best practices, and workflows.
