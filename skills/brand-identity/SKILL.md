---
name: brand-identity
description: Brand Identity (Grok Adapter). Grok-native port/adaptation. This skill provides the Brand Identity capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Brand Identity concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Brand Identity (Grok Adapter)
...
## Role & Purpose
Brand Identity patterns, best practices, and workflows.
