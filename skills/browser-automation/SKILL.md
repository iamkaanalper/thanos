...
description: Browser Automation (Grok Adapter). Grok-native port/adaptation. This skill provides the Browser Automation capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Browser Automation concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Browser Automation (Grok Adapter)
...
## Role & Purpose
Browser Automation patterns, best practices, and workflows.
