...
description: Continuity Ledger (Grok Adapter). Grok-native port/adaptation. This skill provides the Continuity Ledger capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Continuity Ledger concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Continuity Ledger (Grok Adapter)
...
## Role & Purpose
Continuity Ledger patterns, best practices, and workflows.
