...
description: Codex Orchestration (Grok Adapter). Grok-native port/adaptation. This skill provides the Codex Orchestration capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Codex Orchestration concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Codex Orchestration (Grok Adapter)
...
## Role & Purpose
Codex Orchestration patterns, best practices, and workflows.
