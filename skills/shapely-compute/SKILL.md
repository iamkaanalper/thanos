...
description: Shapely Compute (Grok Adapter). Grok-native port/adaptation. This skill provides the Shapely Compute capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Shapely Compute concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Shapely Compute (Grok Adapter)
...
## Role & Purpose
Shapely Compute patterns, best practices, and workflows.
