...
description: Supply Chain Security (Grok Adapter). Grok-native port/adaptation. This skill provides the Supply Chain Security capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Supply Chain Security concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Supply Chain Security (Grok Adapter)
...
## Role & Purpose
Supply Chain Security patterns, best practices, and workflows.
