---
name: repoprompt
description: Repoprompt (Grok Adapter). Grok-native port/adaptation. This skill provides the Repoprompt capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Repoprompt concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Repoprompt (Grok Adapter)
...
## Role & Purpose
Repoprompt patterns, best practices, and workflows.
