...
description: Changelog Automation (Grok Adapter). Grok-native port/adaptation. This skill provides the Changelog Automation capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Changelog Automation concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Changelog Automation (Grok Adapter)
...
## Role & Purpose
Changelog Automation patterns, best practices, and workflows.
