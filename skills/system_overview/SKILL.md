...
description: System Overview (Grok Adapter). Grok-native port/adaptation. This skill provides the System Overview capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves System Overview concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# System Overview (Grok Adapter)
...
## Role & Purpose
System Overview patterns, best practices, and workflows.
