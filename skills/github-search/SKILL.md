---
name: github-search
description: Github Search (Grok Adapter). Grok-native port/adaptation. This skill provides the Github Search capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Github Search concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Github Search (Grok Adapter)
...
## Role & Purpose
Github Search patterns, best practices, and workflows.
