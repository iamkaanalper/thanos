...
description: Competitive Analysis (Grok Adapter). Grok-native port/adaptation. This skill provides the Competitive Analysis capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Competitive Analysis concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Competitive Analysis (Grok Adapter)
...
## Role & Purpose
Competitive Analysis patterns, best practices, and workflows.
