...
description: Agentic Workflow (Grok Adapter). Grok-native port/adaptation. This skill provides the Agentic Workflow capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Agentic Workflow concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Agentic Workflow (Grok Adapter)
...
## Role & Purpose
Agentic Workflow patterns, best practices, and workflows.
