...
description: Springboot Security (Grok Adapter). Grok-native port/adaptation. This skill provides the Springboot Security capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Springboot Security concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Springboot Security (Grok Adapter)
...
## Role & Purpose
Springboot Security patterns, best practices, and workflows.
