...
description: Completion Check (Grok Adapter). Grok-native port/adaptation. This skill provides the Completion Check capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Completion Check concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Completion Check (Grok Adapter)
...
## Role & Purpose
Completion Check patterns, best practices, and workflows.
