---
name: plan-agent
description: Plan Agent (Grok Adapter). Grok-native port/adaptation. This skill provides the Plan Agent capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Plan Agent concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Plan Agent (Grok Adapter)
...
## Role & Purpose
Plan Agent patterns, best practices, and workflows.
