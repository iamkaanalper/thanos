...
description: Continuous Learning (Grok Adapter). Grok-native port/adaptation. This skill provides the Continuous Learning capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Continuous Learning concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Continuous Learning (Grok Adapter)
...
## Role & Purpose
Continuous Learning patterns, best practices, and workflows.
