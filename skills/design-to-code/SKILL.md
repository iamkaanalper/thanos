---
name: design-to-code
description: Design To Code (Grok Adapter). Grok-native port/adaptation. This skill provides the Design To Code capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Design To Code concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Design To Code (Grok Adapter)
...
## Role & Purpose
Design To Code patterns, best practices, and workflows.
