...
description: Insecure Defaults (Grok Adapter). Grok-native port/adaptation. This skill provides the Insecure Defaults capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Insecure Defaults concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Insecure Defaults (Grok Adapter)
...
## Role & Purpose
Insecure Defaults patterns, best practices, and workflows.
