---
name: qlty-check
description: Qlty Check (Grok Adapter). Grok-native port/adaptation. This skill provides the Qlty Check capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Qlty Check concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Qlty Check (Grok Adapter)
...
## Role & Purpose
Qlty Check patterns, best practices, and workflows.
