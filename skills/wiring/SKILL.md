---
name: wiring
description: Wiring (Grok Adapter). Grok-native port/adaptation. This skill provides the Wiring capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Wiring concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---
...
## Role & Purpose
Wiring patterns, best practices, and workflows.
