---
name: oauth-patterns
description: Oauth Patterns (Grok Adapter). Grok-native port/adaptation. This skill provides the Oauth Patterns capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Oauth Patterns concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Oauth Patterns (Grok Adapter)
...
## Role & Purpose
Oauth Patterns patterns, best practices, and workflows.
