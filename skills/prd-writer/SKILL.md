---
name: prd-writer
description: Prd Writer (Grok Adapter). Grok-native port/adaptation. This skill provides the Prd Writer capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Prd Writer concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Prd Writer (Grok Adapter)
...
## Role & Purpose
Prd Writer patterns, best practices, and workflows.
