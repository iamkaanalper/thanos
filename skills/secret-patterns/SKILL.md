...
description: Secret Patterns (Grok Adapter). Grok-native port/adaptation. This skill provides the Secret Patterns capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Secret Patterns concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Secret Patterns (Grok Adapter)
...
## Role & Purpose
Secret Patterns patterns, best practices, and workflows.
