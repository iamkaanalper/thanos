---
name: math-help
description: Math Help (Grok Adapter). Grok-native port/adaptation. This skill provides the Math Help capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Math Help concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Math Help (Grok Adapter)
...
## Role & Purpose
Math Help patterns, best practices, and workflows.
