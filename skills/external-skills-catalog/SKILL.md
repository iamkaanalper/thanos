...
description: External Skills Catalog (Grok Adapter). Grok-native port/adaptation. This skill provides the External Skills Catalog capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves External Skills Catalog concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# External Skills Catalog (Grok Adapter)
...
## Role & Purpose
External Skills Catalog patterns, best practices, and workflows.
