---
name: tdd-workflow
description: Tdd Workflow (Grok Adapter). Grok-native port/adaptation. This skill provides the Tdd Workflow capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Tdd Workflow concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Tdd Workflow (Grok Adapter)
...
## Role & Purpose
Tdd Workflow patterns, best practices, and workflows.
