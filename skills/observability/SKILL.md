---
name: observability
description: Observability (Grok Adapter). Grok-native port/adaptation. This skill provides the Observability capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Observability concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Observability (Grok Adapter)
...
## Role & Purpose
Observability patterns, best practices, and workflows.
