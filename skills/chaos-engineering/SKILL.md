...
description: Chaos Engineering (Grok Adapter). Grok-native port/adaptation. This skill provides the Chaos Engineering capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Chaos Engineering concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Chaos Engineering (Grok Adapter)
...
## Role & Purpose
Chaos Engineering patterns, best practices, and workflows.
