---
name: self-healing
description: Self Healing (Grok Adapter). Grok-native port/adaptation. This skill provides the Self Healing capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Self Healing concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Self Healing (Grok Adapter)
...
## Role & Purpose
Self Healing patterns, best practices, and workflows.
