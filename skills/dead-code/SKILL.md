---
name: dead-code
description: Dead Code (Grok Adapter). Grok-native port/adaptation. This skill provides the Dead Code capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Dead Code concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Dead Code (Grok Adapter)
...
## Role & Purpose
Dead Code patterns, best practices, and workflows.
