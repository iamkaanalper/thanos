...
description: User Story Generator (Grok Adapter). Grok-native port/adaptation. This skill provides the User Story Generator capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves User Story Generator concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# User Story Generator (Grok Adapter)
...
## Role & Purpose
User Story Generator patterns, best practices, and workflows.
