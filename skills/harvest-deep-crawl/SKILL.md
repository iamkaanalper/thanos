...
description: Harvest Deep Crawl (Grok Adapter). Grok-native port/adaptation. This skill provides the Harvest Deep Crawl capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Harvest Deep Crawl concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Harvest Deep Crawl (Grok Adapter)
...
## Role & Purpose
Harvest Deep Crawl patterns, best practices, and workflows.
