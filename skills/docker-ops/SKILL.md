---
name: docker-ops
description: Docker Ops (Grok Adapter). Grok-native port/adaptation. This skill provides the Docker Ops capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Docker Ops concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Docker Ops (Grok Adapter)
...
## Role & Purpose
Docker Ops patterns, best practices, and workflows.
