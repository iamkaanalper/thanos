...
description: Qlty During Development (Grok Adapter). Grok-native port/adaptation. This skill provides the Qlty During Development capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Qlty During Development concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Qlty During Development (Grok Adapter)
...
## Role & Purpose
Qlty During Development patterns, best practices, and workflows.
