...
description: Event Driven Patterns (Grok Adapter). Grok-native port/adaptation. This skill provides the Event Driven Patterns capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Event Driven Patterns concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Event Driven Patterns (Grok Adapter)
...
## Role & Purpose
Event Driven Patterns patterns, best practices, and workflows.
