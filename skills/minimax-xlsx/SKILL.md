---
name: minimax-xlsx
description: Minimax Xlsx (Grok Adapter). Grok-native port/adaptation. This skill provides the Minimax Xlsx capability. In Grok, many specialized skills are implemented via high-leverage patterns + meta skills + general-purpose agents. See bundled/skills and assignment matrix.
when-to-use: When the task involves Minimax Xlsx concepts, patterns, or workflows. Consult the agent-assignment-matrix for exact routing.
---

# Minimax Xlsx (Grok Adapter)
...
## Role & Purpose
Minimax Xlsx patterns, best practices, and workflows.
