---
name: benchmark
description: Benchmark (Grok Adapter). Grok-native delegation for this role. See agent-assignment-matrix.md for the actual primary implementation (general-purpose + skills or dedicated specialist).
keywords: [benchmark, adapter, delegation, grok-native]
---

# Benchmark — Grok Adapter
...
## Role & Responsibility
Benchmark responsibilities (adapted for Grok spawn model and skills surface).
