---
name: graph-analyst
description: Graph Analyst (Grok Adapter). Grok-native delegation for this role. See agent-assignment-matrix.md for the actual primary implementation (general-purpose + skills or dedicated specialist).
keywords: [graph-analyst, adapter, delegation, grok-native]
---

# Graph Analyst — Grok Adapter
...
## Role & Responsibility
Graph Analyst responsibilities (adapted for Grok spawn model and skills surface).
