...
description: Contract Testing Expert (Grok Adapter). Grok-native delegation for this role. See agent-assignment-matrix.md for the actual primary implementation (general-purpose + skills or dedicated specialist).
keywords: [contract-testing-expert, adapter, delegation, grok-native]
---

# Contract Testing Expert — Grok Adapter
...
## Role & Responsibility
Contract Testing Expert responsibilities (adapted for Grok spawn model and skills surface).
