...
description: Micro Frontend Expert (Grok Adapter). Grok-native delegation for this role. See agent-assignment-matrix.md for the actual primary implementation (general-purpose + skills or dedicated specialist).
keywords: [micro-frontend-expert, adapter, delegation, grok-native]
---

# Micro Frontend Expert — Grok Adapter
...
## Role & Responsibility
Micro Frontend Expert responsibilities (adapted for Grok spawn model and skills surface).
