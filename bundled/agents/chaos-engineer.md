---
name: chaos-engineer
description: Chaos Engineer (Grok Adapter). Grok-native delegation for this role. See agent-assignment-matrix.md for the actual primary implementation (general-purpose + skills or dedicated specialist).
keywords: [chaos-engineer, adapter, delegation, grok-native]
---

# Chaos Engineer — Grok Adapter
...
## Role & Responsibility
Chaos Engineer responsibilities (adapted for Grok spawn model and skills surface).
