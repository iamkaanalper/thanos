---
name: maestro
description: Maestro (Grok Adapter). Grok-native delegation for this role. See agent-assignment-matrix.md for the actual primary implementation (general-purpose + skills or dedicated specialist).
keywords: [maestro, adapter, delegation, grok-native]
---

# Maestro — Grok Adapter
...
## Role & Responsibility
Maestro responsibilities (adapted for Grok spawn model and skills surface).
