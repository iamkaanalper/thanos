...
description: Resource Manager (Grok Adapter). Grok-native delegation for this role. See agent-assignment-matrix.md for the actual primary implementation (general-purpose + skills or dedicated specialist).
keywords: [resource-manager, adapter, delegation, grok-native]
---

# Resource Manager — Grok Adapter
...
## Role & Responsibility
Resource Manager responsibilities (adapted for Grok spawn model and skills surface).
