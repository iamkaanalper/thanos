...
description: Memory Extractor (Grok Adapter). Grok-native delegation for this role. See agent-assignment-matrix.md for the actual primary implementation (general-purpose + skills or dedicated specialist).
keywords: [memory-extractor, adapter, delegation, grok-native]
---

# Memory Extractor — Grok Adapter
...
## Role & Responsibility
Memory Extractor responsibilities (adapted for Grok spawn model and skills surface).
