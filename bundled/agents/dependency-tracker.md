...
description: Dependency Tracker (Grok Adapter). Grok-native delegation for this role. See agent-assignment-matrix.md for the actual primary implementation (general-purpose + skills or dedicated specialist).
keywords: [dependency-tracker, adapter, delegation, grok-native]
---

# Dependency Tracker — Grok Adapter
...
## Role & Responsibility
Dependency Tracker responsibilities (adapted for Grok spawn model and skills surface).
