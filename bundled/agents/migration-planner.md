...
description: Migration Planner (Grok Adapter). Grok-native delegation for this role. See agent-assignment-matrix.md for the actual primary implementation (general-purpose + skills or dedicated specialist).
keywords: [migration-planner, adapter, delegation, grok-native]
---

# Migration Planner — Grok Adapter
...
## Role & Responsibility
Migration Planner responsibilities (adapted for Grok spawn model and skills surface).
