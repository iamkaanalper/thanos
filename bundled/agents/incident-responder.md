...
description: Incident Responder (Grok Adapter). Grok-native delegation for this role. See agent-assignment-matrix.md for the actual primary implementation (general-purpose + skills or dedicated specialist).
keywords: [incident-responder, adapter, delegation, grok-native]
---

# Incident Responder — Grok Adapter
...
## Role & Responsibility
Incident Responder responsibilities (adapted for Grok spawn model and skills surface).
