---
name: test-architect
description: Test Architect (Grok Adapter). Grok-native delegation for this role. See agent-assignment-matrix.md for the actual primary implementation (general-purpose + skills or dedicated specialist).
keywords: [test-architect, adapter, delegation, grok-native]
---

# Test Architect — Grok Adapter
...
## Role & Responsibility
Test Architect responsibilities (adapted for Grok spawn model and skills surface).
