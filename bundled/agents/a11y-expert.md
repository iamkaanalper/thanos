---
name: a11y-expert
description: A11Y Expert (Grok Adapter). Grok-native delegation for this role. See agent-assignment-matrix.md for the actual primary implementation (general-purpose + skills or dedicated specialist).
keywords: [a11y-expert, adapter, delegation, grok-native]
---

# A11Y Expert — Grok Adapter
...
## Role & Responsibility
A11Y Expert responsibilities (adapted for Grok spawn model and skills surface).
