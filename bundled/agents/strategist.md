---
name: strategist
description: Strategist (Grok Adapter). Grok-native delegation for this role. See agent-assignment-matrix.md for the actual primary implementation (general-purpose + skills or dedicated specialist).
keywords: [strategist, adapter, delegation, grok-native]
---

# Strategist — Grok Adapter
...
## Role & Responsibility
Strategist responsibilities (adapted for Grok spawn model and skills surface).
