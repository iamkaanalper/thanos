...
description: Dependency Graph Analyzer (Grok Adapter). Grok-native delegation for this role. See agent-assignment-matrix.md for the actual primary implementation (general-purpose + skills or dedicated specialist).
keywords: [dependency-graph-analyzer, adapter, delegation, grok-native]
---

# Dependency Graph Analyzer — Grok Adapter
...
## Role & Responsibility
Dependency Graph Analyzer responsibilities (adapted for Grok spawn model and skills surface).
