...
description: Template Engine (Grok Adapter). Grok-native delegation for this role. See agent-assignment-matrix.md for the actual primary implementation (general-purpose + skills or dedicated specialist).
keywords: [template-engine, adapter, delegation, grok-native]
---

# Template Engine — Grok Adapter
...
## Role & Responsibility
Template Engine responsibilities (adapted for Grok spawn model and skills surface).
