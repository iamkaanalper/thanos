---
name: tracing-expert
description: Tracing Expert (Grok Adapter). Grok-native delegation for this role. See agent-assignment-matrix.md for the actual primary implementation (general-purpose + skills or dedicated specialist).
keywords: [tracing-expert, adapter, delegation, grok-native]
---

# Tracing Expert — Grok Adapter
...
## Role & Responsibility
Tracing Expert responsibilities (adapted for Grok spawn model and skills surface).
