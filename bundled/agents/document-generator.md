...
description: Document Generator (Grok Adapter). Grok-native delegation for this role. See agent-assignment-matrix.md for the actual primary implementation (general-purpose + skills or dedicated specialist).
keywords: [document-generator, adapter, delegation, grok-native]
---

# Document Generator — Grok Adapter
...
## Role & Responsibility
Document Generator responsibilities (adapted for Grok spawn model and skills surface).
