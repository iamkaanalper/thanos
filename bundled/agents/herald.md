---
name: herald
description: Herald (Grok Adapter). Grok-native delegation for this role. See agent-assignment-matrix.md for the actual primary implementation (general-purpose + skills or dedicated specialist).
keywords: [herald, adapter, delegation, grok-native]
---
...
## Role & Responsibility
Herald responsibilities (adapted for Grok spawn model and skills surface).
