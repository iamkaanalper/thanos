...
description: Mutation Tester (Grok Adapter). Grok-native delegation for this role. See agent-assignment-matrix.md for the actual primary implementation (general-purpose + skills or dedicated specialist).
keywords: [mutation-tester, adapter, delegation, grok-native]
---

# Mutation Tester — Grok Adapter
...
## Role & Responsibility
Mutation Tester responsibilities (adapted for Grok spawn model and skills surface).
