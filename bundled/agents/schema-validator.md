...
description: Schema Validator (Grok Adapter). Grok-native delegation for this role. See agent-assignment-matrix.md for the actual primary implementation (general-purpose + skills or dedicated specialist).
keywords: [schema-validator, adapter, delegation, grok-native]
---

# Schema Validator — Grok Adapter
...
## Role & Responsibility
Schema Validator responsibilities (adapted for Grok spawn model and skills surface).
