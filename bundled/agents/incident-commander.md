...
description: Incident Commander (Grok Adapter). Grok-native delegation for this role. See agent-assignment-matrix.md for the actual primary implementation (general-purpose + skills or dedicated specialist).
keywords: [incident-commander, adapter, delegation, grok-native]
---

# Incident Commander — Grok Adapter
...
## Role & Responsibility
Incident Commander responsibilities (adapted for Grok spawn model and skills surface).
