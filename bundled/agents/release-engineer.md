...
description: Release Engineer (Grok Adapter). Grok-native delegation for this role. See agent-assignment-matrix.md for the actual primary implementation (general-purpose + skills or dedicated specialist).
keywords: [release-engineer, adapter, delegation, grok-native]
---

# Release Engineer — Grok Adapter
...
## Role & Responsibility
Release Engineer responsibilities (adapted for Grok spawn model and skills surface).
