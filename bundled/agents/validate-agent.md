---
name: validate-agent
description: Validate Agent (Grok Adapter). Grok-native delegation for this role. See agent-assignment-matrix.md for the actual primary implementation (general-purpose + skills or dedicated specialist).
keywords: [validate-agent, adapter, delegation, grok-native]
---
...
## Role & Responsibility
Validate Agent responsibilities (adapted for Grok spawn model and skills surface).
