---
name: tech-radar
description: Tech Radar (Grok Adapter). Grok-native delegation for this role. See agent-assignment-matrix.md for the actual primary implementation (general-purpose + skills or dedicated specialist).
keywords: [tech-radar, adapter, delegation, grok-native]
---

# Tech Radar — Grok Adapter
...
## Role & Responsibility
Tech Radar responsibilities (adapted for Grok spawn model and skills surface).
