...
description: Monetization Expert (Grok Adapter). Grok-native delegation for this role. See agent-assignment-matrix.md for the actual primary implementation (general-purpose + skills or dedicated specialist).
keywords: [monetization-expert, adapter, delegation, grok-native]
---

# Monetization Expert — Grok Adapter
...
## Role & Responsibility
Monetization Expert responsibilities (adapted for Grok spawn model and skills surface).
