---
name: website-cloner
description: Website Cloner (Grok Adapter). Grok-native delegation for this role. See agent-assignment-matrix.md for the actual primary implementation (general-purpose + skills or dedicated specialist).
keywords: [website-cloner, adapter, delegation, grok-native]
---

# Website Cloner — Grok Adapter
...
## Role & Responsibility
Website Cloner responsibilities (adapted for Grok spawn model and skills surface).
