---
name: agentica-agent
description: Agentica Agent (Grok Adapter). Grok-native delegation for this role. See agent-assignment-matrix.md for the actual primary implementation (general-purpose + skills or dedicated specialist).
keywords: [agentica-agent, adapter, delegation, grok-native]
---

# Agentica Agent — Grok Adapter
...
## Role & Responsibility
Agentica Agent responsibilities (adapted for Grok spawn model and skills surface).
