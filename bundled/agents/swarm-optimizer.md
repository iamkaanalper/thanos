...
description: Swarm Optimizer (Grok Adapter). Grok-native delegation for this role. See agent-assignment-matrix.md for the actual primary implementation (general-purpose + skills or dedicated specialist).
keywords: [swarm-optimizer, adapter, delegation, grok-native]
---

# Swarm Optimizer — Grok Adapter
...
## Role & Responsibility
Swarm Optimizer responsibilities (adapted for Grok spawn model and skills surface).
