...
description: Api Gateway Expert (Grok Adapter). Grok-native delegation for this role. See agent-assignment-matrix.md for the actual primary implementation (general-purpose + skills or dedicated specialist).
keywords: [api-gateway-expert, adapter, delegation, grok-native]
---

# Api Gateway Expert — Grok Adapter
...
## Role & Responsibility
Api Gateway Expert responsibilities (adapted for Grok spawn model and skills surface).
