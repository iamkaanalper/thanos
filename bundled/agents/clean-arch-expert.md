...
description: Clean Arch Expert (Grok Adapter). Grok-native delegation for this role. See agent-assignment-matrix.md for the actual primary implementation (general-purpose + skills or dedicated specialist).
keywords: [clean-arch-expert, adapter, delegation, grok-native]
---

# Clean Arch Expert — Grok Adapter
...
## Role & Responsibility
Clean Arch Expert responsibilities (adapted for Grok spawn model and skills surface).
