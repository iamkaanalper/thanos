...
description: Paywall Planner (Grok Adapter). Grok-native delegation for this role. See agent-assignment-matrix.md for the actual primary implementation (general-purpose + skills or dedicated specialist).
keywords: [paywall-planner, adapter, delegation, grok-native]
---

# Paywall Planner — Grok Adapter
...
## Role & Responsibility
Paywall Planner responsibilities (adapted for Grok spawn model and skills surface).
