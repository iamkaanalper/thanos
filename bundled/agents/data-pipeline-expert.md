...
description: Data Pipeline Expert (Grok Adapter). Grok-native delegation for this role. See agent-assignment-matrix.md for the actual primary implementation (general-purpose + skills or dedicated specialist).
keywords: [data-pipeline-expert, adapter, delegation, grok-native]
---

# Data Pipeline Expert — Grok Adapter
...
## Role & Responsibility
Data Pipeline Expert responsibilities (adapted for Grok spawn model and skills surface).
