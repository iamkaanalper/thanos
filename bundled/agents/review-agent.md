---
name: review-agent
description: Review Agent (Grok Adapter). Grok-native delegation for this role. See agent-assignment-matrix.md for the actual primary implementation (general-purpose + skills or dedicated specialist).
keywords: [review-agent, adapter, delegation, grok-native]
---

# Review Agent — Grok Adapter
...
## Role & Responsibility
Review Agent responsibilities (adapted for Grok spawn model and skills surface).
