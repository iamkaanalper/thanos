---
name: data-modeler
description: Data Modeler (Grok Adapter). Grok-native delegation for this role. See agent-assignment-matrix.md for the actual primary implementation (general-purpose + skills or dedicated specialist).
keywords: [data-modeler, adapter, delegation, grok-native]
---

# Data Modeler — Grok Adapter
...
## Role & Responsibility
Data Modeler responsibilities (adapted for Grok spawn model and skills surface).
