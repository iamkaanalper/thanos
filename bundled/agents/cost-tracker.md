---
name: cost-tracker
description: Cost Tracker (Grok Adapter). Grok-native delegation for this role. See agent-assignment-matrix.md for the actual primary implementation (general-purpose + skills or dedicated specialist).
keywords: [cost-tracker, adapter, delegation, grok-native]
---

# Cost Tracker — Grok Adapter
...
## Role & Responsibility
Cost Tracker responsibilities (adapted for Grok spawn model and skills surface).
