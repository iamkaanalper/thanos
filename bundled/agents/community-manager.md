...
description: Community Manager (Grok Adapter). Grok-native delegation for this role. See agent-assignment-matrix.md for the actual primary implementation (general-purpose + skills or dedicated specialist).
keywords: [community-manager, adapter, delegation, grok-native]
---

# Community Manager — Grok Adapter
...
## Role & Responsibility
Community Manager responsibilities (adapted for Grok spawn model and skills surface).
