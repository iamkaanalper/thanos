---
name: code-generator
description: Code Generator (Grok Adapter). Grok-native delegation for this role. See agent-assignment-matrix.md for the actual primary implementation (general-purpose + skills or dedicated specialist).
keywords: [code-generator, adapter, delegation, grok-native]
---

# Code Generator — Grok Adapter
...
## Role & Responsibility
Code Generator responsibilities (adapted for Grok spawn model and skills surface).
