---
name: swift-expert
description: Swift Expert (Grok Adapter). Grok-native delegation for this role. See agent-assignment-matrix.md for the actual primary implementation (general-purpose + skills or dedicated specialist).
keywords: [swift-expert, adapter, delegation, grok-native]
---

# Swift Expert — Grok Adapter
...
## Role & Responsibility
Swift Expert responsibilities (adapted for Grok spawn model and skills surface).
