...
description: Session Replay Analyzer (Grok Adapter). Grok-native delegation for this role. See agent-assignment-matrix.md for the actual primary implementation (general-purpose + skills or dedicated specialist).
keywords: [session-replay-analyzer, adapter, delegation, grok-native]
---

# Session Replay Analyzer — Grok Adapter
...
## Role & Responsibility
Session Replay Analyzer responsibilities (adapted for Grok spawn model and skills surface).
