---
name: surveyor
description: Surveyor (Grok Adapter). Grok-native delegation for this role. See agent-assignment-matrix.md for the actual primary implementation (general-purpose + skills or dedicated specialist).
keywords: [surveyor, adapter, delegation, grok-native]
---

# Surveyor — Grok Adapter
...
## Role & Responsibility
Surveyor responsibilities (adapted for Grok spawn model and skills surface).
