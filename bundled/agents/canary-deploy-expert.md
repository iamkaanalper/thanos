...
description: Canary Deploy Expert (Grok Adapter). Grok-native delegation for this role. See agent-assignment-matrix.md for the actual primary implementation (general-purpose + skills or dedicated specialist).
keywords: [canary-deploy-expert, adapter, delegation, grok-native]
---

# Canary Deploy Expert — Grok Adapter
...
## Role & Responsibility
Canary Deploy Expert responsibilities (adapted for Grok spawn model and skills surface).
