---
name: i18n-expert
description: I18N Expert (Grok Adapter). Grok-native delegation for this role. See agent-assignment-matrix.md for the actual primary implementation (general-purpose + skills or dedicated specialist).
keywords: [i18n-expert, adapter, delegation, grok-native]
---

# I18N Expert — Grok Adapter
...
## Role & Responsibility
I18N Expert responsibilities (adapted for Grok spawn model and skills surface).
