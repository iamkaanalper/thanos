---
name: tech-lead
description: Tech Lead (Grok Adapter). Grok-native delegation for this role. See agent-assignment-matrix.md for the actual primary implementation (general-purpose + skills or dedicated specialist).
keywords: [tech-lead, adapter, delegation, grok-native]
---

# Tech Lead — Grok Adapter
...
## Role & Responsibility
Tech Lead responsibilities (adapted for Grok spawn model and skills surface).
