---
name: scribe
description: Scribe (Grok Adapter). Grok-native delegation for this role. See agent-assignment-matrix.md for the actual primary implementation (general-purpose + skills or dedicated specialist).
keywords: [scribe, adapter, delegation, grok-native]
---
...
## Role & Responsibility
Scribe responsibilities (adapted for Grok spawn model and skills surface).
