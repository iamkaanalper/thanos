---
name: mcp-manager
description: Mcp Manager (Grok Adapter). Grok-native delegation for this role. See agent-assignment-matrix.md for the actual primary implementation (general-purpose + skills or dedicated specialist).
keywords: [mcp-manager, adapter, delegation, grok-native]
---

# Mcp Manager — Grok Adapter
...
## Role & Responsibility
Mcp Manager responsibilities (adapted for Grok spawn model and skills surface).
