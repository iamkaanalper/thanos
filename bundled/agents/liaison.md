---
name: liaison
description: Liaison (Grok Adapter). Grok-native delegation for this role. See agent-assignment-matrix.md for the actual primary implementation (general-purpose + skills or dedicated specialist).
keywords: [liaison, adapter, delegation, grok-native]
---

# Liaison — Grok Adapter
...
## Role & Responsibility
Liaison responsibilities (adapted for Grok spawn model and skills surface).
