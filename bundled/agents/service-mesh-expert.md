...
description: Service Mesh Expert (Grok Adapter). Grok-native delegation for this role. See agent-assignment-matrix.md for the actual primary implementation (general-purpose + skills or dedicated specialist).
keywords: [service-mesh-expert, adapter, delegation, grok-native]
---

# Service Mesh Expert — Grok Adapter
...
## Role & Responsibility
Service Mesh Expert responsibilities (adapted for Grok spawn model and skills surface).
