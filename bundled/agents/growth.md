---
name: growth
description: Growth (Grok Adapter). Grok-native delegation for this role. See agent-assignment-matrix.md for the actual primary implementation (general-purpose + skills or dedicated specialist).
keywords: [growth, adapter, delegation, grok-native]
---
...
## Role & Responsibility
Growth responsibilities (adapted for Grok spawn model and skills surface).
