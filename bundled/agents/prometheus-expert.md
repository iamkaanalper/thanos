...
description: Prometheus Expert (Grok Adapter). Grok-native delegation for this role. See agent-assignment-matrix.md for the actual primary implementation (general-purpose + skills or dedicated specialist).
keywords: [prometheus-expert, adapter, delegation, grok-native]
---

# Prometheus Expert — Grok Adapter
...
## Role & Responsibility
Prometheus Expert responsibilities (adapted for Grok spawn model and skills surface).
