---
name: kotlin-expert
description: Kotlin Expert (Grok Adapter). Grok-native delegation for this role. See agent-assignment-matrix.md for the actual primary implementation (general-purpose + skills or dedicated specialist).
keywords: [kotlin-expert, adapter, delegation, grok-native]
---

# Kotlin Expert — Grok Adapter
...
## Role & Responsibility
Kotlin Expert responsibilities (adapted for Grok spawn model and skills surface).
