...
description: Security Analyst (Grok Adapter). Grok-native delegation for this role. See agent-assignment-matrix.md for the actual primary implementation (general-purpose + skills or dedicated specialist).
keywords: [security-analyst, adapter, delegation, grok-native]
---

# Security Analyst — Grok Adapter
...
## Role & Responsibility
Security Analyst responsibilities (adapted for Grok spawn model and skills surface).
