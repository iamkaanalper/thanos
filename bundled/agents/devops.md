---
name: devops
description: Devops (Grok Adapter). Grok-native delegation for this role. See agent-assignment-matrix.md for the actual primary implementation (general-purpose + skills or dedicated specialist).
keywords: [devops, adapter, delegation, grok-native]
---
...
## Role & Responsibility
Devops responsibilities (adapted for Grok spawn model and skills surface).
