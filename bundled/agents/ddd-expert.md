---
name: ddd-expert
description: Ddd Expert (Grok Adapter). Grok-native delegation for this role. See agent-assignment-matrix.md for the actual primary implementation (general-purpose + skills or dedicated specialist).
keywords: [ddd-expert, adapter, delegation, grok-native]
---

# Ddd Expert — Grok Adapter
...
## Role & Responsibility
Ddd Expert responsibilities (adapted for Grok spawn model and skills surface).
