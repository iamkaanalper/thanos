...
description: Reputation Engine (Grok Adapter). Grok-native delegation for this role. See agent-assignment-matrix.md for the actual primary implementation (general-purpose + skills or dedicated specialist).
keywords: [reputation-engine, adapter, delegation, grok-native]
---

# Reputation Engine — Grok Adapter
...
## Role & Responsibility
Reputation Engine responsibilities (adapted for Grok spawn model and skills surface).
