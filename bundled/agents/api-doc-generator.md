...
description: Api Doc Generator (Grok Adapter). Grok-native delegation for this role. See agent-assignment-matrix.md for the actual primary implementation (general-purpose + skills or dedicated specialist).
keywords: [api-doc-generator, adapter, delegation, grok-native]
---

# Api Doc Generator — Grok Adapter
...
## Role & Responsibility
Api Doc Generator responsibilities (adapted for Grok spawn model and skills surface).
