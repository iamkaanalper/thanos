---
name: log-analyzer
description: Log Analyzer (Grok Adapter). Grok-native delegation for this role. See agent-assignment-matrix.md for the actual primary implementation (general-purpose + skills or dedicated specialist).
keywords: [log-analyzer, adapter, delegation, grok-native]
---

# Log Analyzer — Grok Adapter
...
## Role & Responsibility
Log Analyzer responsibilities (adapted for Grok spawn model and skills surface).
