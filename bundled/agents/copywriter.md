---
name: copywriter
description: Copywriter (Grok Adapter). Grok-native delegation for this role. See agent-assignment-matrix.md for the actual primary implementation (general-purpose + skills or dedicated specialist).
keywords: [copywriter, adapter, delegation, grok-native]
---

# Copywriter — Grok Adapter
...
## Role & Responsibility
Copywriter responsibilities (adapted for Grok spawn model and skills surface).
