...
description: Documentation Architect (Grok Adapter). Grok-native delegation for this role. See agent-assignment-matrix.md for the actual primary implementation (general-purpose + skills or dedicated specialist).
keywords: [documentation-architect, adapter, delegation, grok-native]
---

# Documentation Architect — Grok Adapter
...
## Role & Responsibility
Documentation Architect responsibilities (adapted for Grok spawn model and skills surface).
