...
description: Api Versioning Expert (Grok Adapter). Grok-native delegation for this role. See agent-assignment-matrix.md for the actual primary implementation (general-purpose + skills or dedicated specialist).
keywords: [api-versioning-expert, adapter, delegation, grok-native]
---

# Api Versioning Expert — Grok Adapter
...
## Role & Responsibility
Api Versioning Expert responsibilities (adapted for Grok spawn model and skills surface).
