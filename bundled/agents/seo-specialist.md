---
name: seo-specialist
description: Seo Specialist (Grok Adapter). Grok-native delegation for this role. See agent-assignment-matrix.md for the actual primary implementation (general-purpose + skills or dedicated specialist).
keywords: [seo-specialist, adapter, delegation, grok-native]
---

# Seo Specialist — Grok Adapter
...
## Role & Responsibility
Seo Specialist responsibilities (adapted for Grok spawn model and skills surface).
