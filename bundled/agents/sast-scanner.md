---
name: sast-scanner
description: Sast Scanner (Grok Adapter). Grok-native delegation for this role. See agent-assignment-matrix.md for the actual primary implementation (general-purpose + skills or dedicated specialist).
keywords: [sast-scanner, adapter, delegation, grok-native]
---

# Sast Scanner — Grok Adapter
...
## Role & Responsibility
Sast Scanner responsibilities (adapted for Grok spawn model and skills surface).
