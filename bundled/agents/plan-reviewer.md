---
name: plan-reviewer
description: Plan Reviewer (Grok Adapter). Grok-native delegation for this role. See agent-assignment-matrix.md for the actual primary implementation (general-purpose + skills or dedicated specialist).
keywords: [plan-reviewer, adapter, delegation, grok-native]
---

# Plan Reviewer — Grok Adapter
...
## Role & Responsibility
Plan Reviewer responsibilities (adapted for Grok spawn model and skills surface).
