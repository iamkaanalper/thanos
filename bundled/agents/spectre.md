---
name: spectre
description: Spectre (Grok Adapter). Grok-native delegation for this role. See agent-assignment-matrix.md for the actual primary implementation (general-purpose + skills or dedicated specialist).
keywords: [spectre, adapter, delegation, grok-native]
---

# Spectre — Grok Adapter
...
## Role & Responsibility
Spectre responsibilities (adapted for Grok spawn model and skills surface).
