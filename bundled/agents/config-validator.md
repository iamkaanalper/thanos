...
description: Config Validator (Grok Adapter). Grok-native delegation for this role. See agent-assignment-matrix.md for the actual primary implementation (general-purpose + skills or dedicated specialist).
keywords: [config-validator, adapter, delegation, grok-native]
---

# Config Validator — Grok Adapter
...
## Role & Responsibility
Config Validator responsibilities (adapted for Grok spawn model and skills surface).
