---
name: psyche
description: Psyche (Grok Adapter). Grok-native delegation for this role. See agent-assignment-matrix.md for the actual primary implementation (general-purpose + skills or dedicated specialist).
keywords: [psyche, adapter, delegation, grok-native]
---
...
## Role & Responsibility
Psyche responsibilities (adapted for Grok spawn model and skills surface).
