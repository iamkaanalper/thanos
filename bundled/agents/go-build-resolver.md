...
description: Go Build Resolver (Grok Adapter). Grok-native delegation for this role. See agent-assignment-matrix.md for the actual primary implementation (general-purpose + skills or dedicated specialist).
keywords: [go-build-resolver, adapter, delegation, grok-native]
---

# Go Build Resolver — Grok Adapter
...
## Role & Responsibility
Go Build Resolver responsibilities (adapted for Grok spawn model and skills surface).
