---
name: api-designer
description: Api Designer (Grok Adapter). Grok-native delegation for this role. See agent-assignment-matrix.md for the actual primary implementation (general-purpose + skills or dedicated specialist).
keywords: [api-designer, adapter, delegation, grok-native]
---

# Api Designer — Grok Adapter
...
## Role & Responsibility
Api Designer responsibilities (adapted for Grok spawn model and skills surface).
